...
@unpack gamma, iso_weight, two_cycle_walk_frac, num_dists, pop_dev, node_data,
        pop_col, geo_units, measure_scores, measure_specs, measure_params,
        writer_stats, area_col,
...
measure = build_measure(measure_specs, measure_params;
                        context=(graph=graph, base_graph=base_graph,
                                 num_dists=num_dists, pop_col=pop_col))
